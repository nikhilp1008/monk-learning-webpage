    ...
    <div className="min-h-screen flex flex-col bg-ruled-body">
      ...
      <main className="flex-1 max-w-[1180px] w-full mx-auto px-6 md:px-11 py-8 space-y-5 animate-ml-rise">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.3fr_1fr_1fr] gap-[18px]">
          ...
          <Link
            href="/lessons"
            className="relative overflow-hidden flex flex-col p-6 rounded-[22px] bg-dark-bg text-[#EFEBDD] border border-dark-border shadow-ref-hero hover:-translate-y-1 transition-transform group"
          >
            <span
            ...
            <div className="relative flex items-center justify-between z-10">
              ...
              <span className="font-extrabold text-[0.56rem] tracking-[0.1em] uppercase rounded-[6px] px-2.5 py-1 bg-orange-light/15 text-orange-light border border-orange-light/30">
                Most loved
              </span>
            </div>
            ...
            <span className="relative inline-flex items-center gap-2 font-bold text-[0.9rem] px-[20px] py-[11px] rounded-full bg-orange text-dark-card mt-4 self-start shadow-ref-pill group-hover:bg-orange-light transition-colors z-10">
              Choose a topic
          ...
          {/* Action Card 2: Snap a doubt (Disabled with Viewfinder Corners) */}
          <div className="flex flex-col p-5 rounded-[22px] bg-white border border-border-subtle shadow-ref-card opacity-70 cursor-not-allowed">
            <div className="relative flex-1 min-h-[128px] rounded-[14px] bg-[#FBF8EF] border border-[rgba(28,26,22,0.07)] flex flex-col items-center justify-center gap-2 p-4">
              ...
              <span className="w-[44px] h-[44px] rounded-full bg-white border border-border-subtle grid place-items-center shadow-xs">
                <svg
                  viewBox="0 0 24 24"
              ...
              <span className="text-center font-semibold text-[0.82rem] text-ink-light leading-snug">
                Drop, paste or snap<br />
                <b className="text-ink font-bold">max 2 questions</b>
              </span>
            </div>
            <div className="mt-3.5 flex items-center justify-between">
              <h3 className="font-bold text-[1.14rem] tracking-[-0.02em] text-ink">Snap a doubt</h3>
          ...
          {/* Action Card 3: Practice unlimited (Disabled with 6 / ∞ styling) */}
          <div className="flex flex-col p-5 rounded-[22px] bg-white border border-border-subtle shadow-ref-card opacity-70 cursor-not-allowed">
            <div className="flex-1 flex flex-col items-center justify-center min-h-[128px] rounded-[14px] bg-[#FBF8EF] border border-[rgba(28,26,22,0.07)] p-4">
              <span className="flex items-baseline gap-1 leading-none">
                <b className="font-bold text-[2.5rem] tracking-[-0.03em] text-ink">6</b>
                <span className="font-semibold text-[1.5rem] text-ink-muted"> / </span>
                <span className="font-bold text-[2rem] text-orange relative top-[2px]">∞</span>
              </span>
              <span className="font-bold text-[0.62rem] tracking-[0.12em] uppercase text-ink-muted mt-2">
                solved today · never runs out
              </span>
            </div>
            <div className="mt-3.5 flex items-center justify-between">
              <h3 className="font-bold text-[1.14rem] tracking-[-0.02em] text-ink">Practice unlimited</h3>
              <span className="font-extrabold text-[0.58rem] tracking-wider uppercase text-ink-muted bg-ink/5 px-2 py-0.5 rounded-full">
                COMING SOON
              </span>
            </div>
        ...
        {/* 3. Stat Cards Row (Exact 18px padding, 18px radius) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[18px]">
          <div className="flex items-center gap-[13px] bg-white border border-border-subtle rounded-[18px] p-[16px_20px] shadow-ref-stat">
            <span className="font-bold text-[2rem] leading-none tracking-[-0.03em] text-ink flex-none min-w-[45px]">
              {questionsPracticed}
            </span>
            <div>
              <b className="block font-bold text-[0.86rem] text-ink">
                questions practiced
              </b>
          ...
          <div className="flex items-center gap-[13px] bg-white border border-border-subtle rounded-[18px] p-[16px_20px] shadow-ref-stat">
            <span className="font-bold text-[2rem] leading-none tracking-[-0.03em] text-green-badge flex-none min-w-[45px]">
              {chaptersStarted}
            </span>
            <div>
              <b className="block font-bold text-[0.86rem] text-ink">
              ...
              <span className="text-[0.72rem] text-green-badge font-bold">
        ...
        <div className="bg-white border border-border-subtle rounded-[18px] p-[18px_22px] shadow-ref-stat">
        ...
        {/* 5. Static Placeholders (Grid ratio 1.3fr 1fr, Ruled Notebook Paper, Kalam script -0.6deg) */}
        <div className="grid grid-cols-1 md:grid-cols-[1.3fr_1fr] gap-[18px]">
          {/* Doubt of the Day Card (Ruled Notebook Paper) */}
          <div className="relative flex flex-col justify-between bg-ruled-card border border-[rgba(28,26,22,0.12)] rounded-[16px] p-[20px_24px_20px_48px] shadow-ref-card overflow-hidden min-h-[160px]">
            <span
              aria-hidden="true"
              className="absolute top-[12px] bottom-[12px] left-[32px] w-[1.5px] bg-red-note/40 pointer-events-none"
            />

            <div>
              <div className="flex items-center justify-between gap-3">
                <span className="font-script font-bold text-red-note text-[1rem] -rotate-[0.6deg] inline-block">
                  doubt of the day
                </span>
                <span className="font-extrabold text-[0.6rem] tracking-[0.1em] uppercase text-red-dark">
                  Physics · Modern
                </span>
              </div>

              <p className="mt-2 leading-[1.55] text-[1.02rem] text-ink font-medium">
                Why do photoelectrons stop the moment intensity drops — but not when frequency drops below threshold?
              </p>
            </div>

            <span className="font-semibold text-xs text-ink-light mt-4 inline-flex items-center gap-2">
              Learn this with Monk →
            </span>
          </div>

          {/* Today's Plan Placeholder */}
          <div className="bg-white border border-border-subtle rounded-[18px] p-[18px_22px] shadow-ref-stat flex flex-col justify-between">
            <div>
