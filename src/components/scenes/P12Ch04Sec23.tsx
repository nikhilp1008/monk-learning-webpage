...
export default function P12Ch04Sec23({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 7, 8, 10 & 11: NEET Speed Trap: Same Voltage Acceleration */}
      ...
      <Fade on={beat >= 11}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Result: Torque τ = 0.29 N m (normal angle 60° lein) | Same voltage radius ratio r_α/r_p = √2! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
