...
export default function P12Ch04Sec3({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 4 & 6: Standard Wire Results */}
      ...
      <Fade on={beat >= 4} dim={beat >= 10}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            Infinite Wire: B = μ₀I / (2πa)   |   Finite: (μ₀I/4πa)(sinθ₁ + sinθ₂)
          </T>
          <T x={240} y={52} anchor="middle" size={15} fill={GREEN} weight={800}>
            Loop Center: B = μ₀I / (2R)   |   Arc: B = μ₀I φ / (4πR)
          </T>
        </g>
      </Fade>

      {/* BEAT 10 & 11: On-Axis Circular Loop Field */}
      ...
      <Fade on={beat >= 10}>
        <g transform="translate(60, 290)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            B_axis = μ₀ I R² / [2 (x² + R²)³/²]   (For N turns: multiply by N)
          </T>
        </g>
      </Fade>
