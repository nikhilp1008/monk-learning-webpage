...
export default function P12Ch03Sec46({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 2: Power Function */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">POWER FUNCTION P(R)</T>
      </Fade>
      ...
      {/* BEAT 3 & 4: Differentiation dP/dR = 0 */}
      <Badge n={2} cx={540} cy={140} on={beat >= 3} delay={dl(3, 0.4)} />
      <Fade on={beat >= 3} delay={dl(3, 0.8)}>
        <T x={562} y={145} size={14} fill={RED} weight={700} anchor="start">DIFFERENTIATE & SET TO ZERO</T>
      </Fade>
      ...
      {/* BEAT 5: Max Power & Efficiency */}
      <Badge n={3} cx={52} cy={270} on={beat >= 5} delay={dl(5, 0.4)} />
      <Fade on={beat >= 5} delay={dl(5, 0.8)}>
        <T x={74} y={275} size={14} fill={RED} weight={700} anchor="start">MAX POWER & EFFICIENCY</T>
      </Fade>
      <Fade on={beat >= 5}>
        <g transform="translate(60, 290)">
          <rect x={0} y={5} width={960} height={50} rx={8} fill={CREAM} stroke={GREEN} strokeWidth={1.8} />
          <T x={480} y={35} anchor="middle" size={18} fill={GREEN} weight={800}>
            P_max = E² / (4 r)   |   Efficiency η = P_load / P_total = 50%
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 5}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Derived! Maximum power transfer R = r par P_max = E²/(4r) aur η = 50% deta hai! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
