...
export default function P12Ch03Sec27({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1: Don't drop the 1 */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">KEEP THE 1 IN R_T = R₀(1 + αΔT)</T>
      </Fade>
      <Fade on={beat >= 1} dim={beat >= 3}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={35} anchor="middle" size={15} fill={INK} weight={800} script>
            {t(
              "The '1' preserves original R₀; αΔT calculates only the change!",
              "'1' original R₀ ko rakhta hai; αΔT sirf change nikaalta hai!"
            )}
          </T>
        </g>
      </Fade>

      {/* BEAT 3: Signs of Alpha */}
      <Badge n={2} cx={540} cy={140} on={beat >= 3} delay={dl(3, 0.4)} />
      <Fade on={beat >= 3} delay={dl(3, 0.8)}>
        <T x={562} y={145} size={14} fill={RED} weight={700} anchor="start">SIGNS OF ALPHA</T>
      </Fade>
      <Fade on={beat >= 3} dim={beat >= 5}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={35} anchor="middle" size={15} fill={INK} weight={800} script>
            {t(
              "Metals: +α  |  Semiconductors: −α  |  Alloys: α ≈ 0",
              "Metals: +α  |  Semiconductors: −α  |  Alloys: α ≈ 0"
            )}
          </T>
        </g>
      ...
      {/* BEAT 5: Pro-Tip Ratio Method */}
      <Badge n={3} cx={52} cy={270} on={beat >= 5} delay={dl(5, 0.4)} />
      <Fade on={beat >= 5} delay={dl(5, 0.8)}>
        <T x={74} y={275} size={14} fill={RED} weight={700} anchor="start">PRO-TIP: RATIO METHOD</T>
      </Fade>
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(60, 290)">
          <rect x={0} y={5} width={960} height={50} rx={8} fill={CREAM} stroke={GREEN} strokeWidth={1.8} />
          <T x={480} y={35} anchor="middle" size={16} fill={INK} weight={800}>
            R_T / R_0 = 1 + α ΔT   (Solves most temperature questions in 1 step!)
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            "★ Ratio Method (R_T/R_0 = 1 + αΔT) avoids tracking absolute values until the end! ✓",
            "★ Ratio Method (R_T/R_0 = 1 + αΔT) se calculation fast aur error-free hoti hai! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
