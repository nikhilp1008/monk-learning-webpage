...
export default function P12Ch04Sec30({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1, 3 & 4: Series Voltage Addition */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">SERIES CHAIN VOLTAGE ADDITION</T>
      </Fade>
      <Fade on={beat >= 1} dim={beat >= 4}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            (Coil G and Multiplier R connected in series)
          </T>
        </g>
      </Fade>

      {/* BEAT 4 & 5: Derived Multiplier Formula */}
      <Badge n={2} cx={540} cy={140} on={beat >= 4} delay={dl(4, 0.4)} />
      <Fade on={beat >= 4} delay={dl(4, 0.8)}>
        <T x={562} y={145} size={14} fill={RED} weight={700} anchor="start">DERIVED MULTIPLIER FORMULA</T>
      </Fade>
      <Fade on={beat >= 4} dim={beat >= 6}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={52} anchor="middle" size={14} fill={GREEN} weight={700}>
            (Never drop the −G term in exam derivations!)
          </T>
        </g>
      </Fade>

      {/* BEAT 6: Effective Voltmeter Resistance */}
      <Badge n={3} cx={52} cy={270} on={beat >= 6} delay={dl(6, 0.4)} />
      <Fade on={beat >= 6} delay={dl(6, 0.8)}>
        <T x={74} y={275} size={14} fill={RED} weight={700} anchor="start">EFFECTIVE VOLTMETER RESISTANCE R_V</T>
      </Fade>
      <Fade on={beat >= 6}>
        <g transform="translate(60, 290)">
          <rect x={0} y={5} width={960} height={50} rx={8} fill={CREAM} stroke={GREEN} strokeWidth={1.8} />
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            R_V = G + R = V / I_g  (Large resistance, draws negligible current from circuit!)
          </T>
        </g>
      </Fade>
