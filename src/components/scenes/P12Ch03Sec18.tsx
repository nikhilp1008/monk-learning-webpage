  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">CARRIER DENSITY (n) CONTROLS RESISTIVITY</T>
      </Fade>
      ...
      {/* BEAT 3: Metals (Copper) */}
      <Badge n={2} cx={540} cy={140} on={beat >= 3} delay={dl(3, 0.4)} />
      <Fade on={beat >= 3} delay={dl(3, 0.8)}>
        <T x={562} y={145} size={14} fill={RED} weight={700} anchor="start">METALS (COPPER)</T>
      </Fade>
      <Fade on={beat >= 3} dim={beat >= 5}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={35} anchor="middle" size={15} fill={INK} weight={800} script>
            {t(
              "Huge n ≈ 10²⁸ m⁻³  ⇒  Extremely Low ρ ≈ 10⁻⁸ Ω·m",
              "Bohot bada n ≈ 10²⁸ m⁻³  ⇒  Bohot chota ρ ≈ 10⁻⁸ Ω·m"
            )}
          </T>
        </g>
      </Fade>

      {/* BEAT 5: Insulators (Rubber) */}
      <Badge n={3} cx={52} cy={270} on={beat >= 5} delay={dl(5, 0.4)} />
      <Fade on={beat >= 5} delay={dl(5, 0.8)}>
        <T x={74} y={275} size={14} fill={RED} weight={700} anchor="start">INSULATORS (RUBBER)</T>
      </Fade>
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(60, 290)">
          ...
          <T x={480} y={35} anchor="middle" size={15} fill={RED} weight={800} script>
            {t(
              "Negligible free e⁻ (n ≈ 0, tightly bound)  ⇒  Huge ρ > 10¹⁶ Ω·m",
              "Na ke barabar free e⁻ (n ≈ 0)  ⇒  Bohot bada ρ > 10¹⁶ Ω·m"
            )}
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Copper aur rubber ke beech resistivity mein 10²⁴ guna ka shandar antar hai! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
