...
export default function P12Ch06Sec51({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: Instantaneous EMF and Current */}
      ...
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            ε(t) = ε₀ sin(ωt)  |  I(t) = I₀ sin(ωt)
          </T>
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            Where peak voltage ε₀ = NBAω and peak current I₀ = ε₀ / R!
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Instantaneous & Average Power */}
      ...
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={30} anchor="middle" size={16} fill={GREEN} weight={800}>
            ⟨P⟩ = (1 / 2) ε₀ I₀ = ε_rms I_rms
          </T>
          <T x={240} y={52} anchor="middle" size={14} fill={INK} weight={700}>
            {t("Since average of sin²(ωt) over one full cycle is 1/2!", "Kyunki full cycle par sin²(ωt) ka average 1/2 hota hai!")}
          </T>
        </g>
      </Fade>

      {/* BEAT 7: Peak vs Average Power Summary */}
      ...
      <Fade on={beat >= 7}>
        <g transform="translate(60, 360)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            P_peak = ε₀ I₀, while Average Power ⟨P⟩ = ½ ε₀ I₀ = ε_rms I_rms!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={490} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Instantaneous Power P(t) = ε₀ I₀ sin²(ωt) aur Average Power ⟨P⟩ = ½ ε₀ I₀ = ε_rms I_rms! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
