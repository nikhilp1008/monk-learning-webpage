...
export default function P12Ch06Sec62({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: Current Relation I(x) = Blx / L */}
      ...
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            L dI = B l dx  ⇒  I(x) = (B l / L) x
          </T>
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            Current grows linearly with displacement x!
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Restoring Force & SHM Frequency */}
      ...
      <Fade on={beat >= 7}>
        <g transform="translate(60, 360)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            Rod sliding on inductor rails undergoes pure Simple Harmonic Motion with frequency ω = B l / √(m L) and period T = 2π √(m L) / (B l)!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={490} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ JEE Advanced Result: Inductor rails par sliding rod SHM undergo karti hai with frequency ω_SHM = B l / √(m L)! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
