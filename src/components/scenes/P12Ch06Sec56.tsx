...
export default function P12Ch06Sec56({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: RMS Voltmeters read V_rms */}
      ...
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            Household 220V AC  ⇒  Peak ε₀ = 220 × √2 = 311 V!
          </T>
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            Don't confuse peak amplitude ε₀ with RMS reading ε_rms!
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Phase Angle Trap */}
      ...
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            If angle with coil plane is α
          </T>
          <T x={240} y={52} anchor="middle" size={15} fill={GREEN} weight={800}>
            Normal angle θ₀ = 90° − α  ⇒  ε(t) = ε₀ sin(ωt + 90° − α)!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <g transform="translate(60, 360)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            When a question asks for "meter reading", ALWAYS calculate RMS value ε_rms = ε₀ / √2!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={490} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ NEET Speed Trap: AC Voltmeter RMS ε_rms = ε₀ / √2 read karta hai, aur peak amplitude ε₀ = √2 ε_rms hota hai! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
