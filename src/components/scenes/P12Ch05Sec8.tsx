    ...
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      <Fade on={beat >= 0} delay={dl(0, 0.4)}>
        <T x={540} y={58} size={24} fill={RED} script>
          {t("Derivation: Torque on a Dipole in a Uniform Field", "Derivation: Uniform Field mein Dipole par Torque")}
        </T>
      </Fade>
      <Draw on={beat >= 0} delay={dl(0, 2.5)} d="M 200 70 C 440 66, 640 74, 880 69" stroke={RED} sw={2.4} dur={0.7} />

      {/* BEAT 1 & 3: Couple Forces */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">
          {t("STEP 1: FORCES FORM A COUPLE (NET FORCE = 0)", "STEP 1: FORCES COUPLE BANATI HAIN (NET FORCE = 0)")}
        </T>
      </Fade>
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={16} fill={INK} weight={800}>
            F_N = +q_m B (along B)  |  F_S = −q_m B (opposite B)
          </T>
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            {t("F_net = F_N + F_S = 0 ⇒ No translational movement!", "F_net = 0 ⇒ Koi translational motion nahi!")}
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Moment Arm and Torque */}
      ...
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={52} anchor="middle" size={14} fill={INK} weight={700}>
            τ = (q_m B) × (2l sin θ) = (q_m 2l) B sin θ
          </T>
        </g>
      </Fade>

      {/* BEAT 7: Final Vector Form */}
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={490} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Torque τ = m × B dipole m ko uniform field B ke parallel rotate karta hai! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
