...
export default function P12Ch06Sec47({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: Rotating Coil Flux Linkage */}
      ...
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            Angle θ = ωt varies continuously as armature spins!
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Sinusoidal EMF Output */}
      ...
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={30} anchor="middle" size={18} fill={GREEN} weight={800}>
            ε(t) = N B A ω sin(ωt) = ε₀ sin(ωt)
          </T>
          <T x={240} y={52} anchor="middle" size={14} fill={INK} weight={700}>
            {t("Peak EMF ε₀ = N B A ω occurs when plane of coil is PARALLEL to B!", "Peak EMF ε₀ = N B A ω tab hota hai jab coil plane B ke PARALLEL ho!")}
          </T>
        </g>
      </Fade>

      {/* BEAT 7: Slip Rings & Brushes Function */}
      <Badge n={3} cx={52} cy={340} on={beat >= 7} delay={dl(7, 0.4)} />
      <Fade on={beat >= 7} delay={dl(7, 0.8)}>
        <T x={74} y={345} size={14} fill={RED} weight={700} anchor="start">
          {t("SLIP RINGS & CARBON BRUSHES", "SLIP RINGS & CARBON BRUSHES")}
        </T>
      </Fade>
      <Fade on={beat >= 7}>
        <g transform="translate(60, 360)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            Slip rings continuously maintain electrical contact with rotating armature coil without twisting external wires!
          </T>
        </g>
      </Fade>
