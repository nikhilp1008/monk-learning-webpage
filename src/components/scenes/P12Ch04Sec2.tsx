...
export default function P12Ch04Sec2({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: Grip Rule & Sine Dependence */}
      ...
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={35} anchor="middle" size={15} fill={INK} weight={800} script>
            {t(
              "Field circles the wire (Right hand rule); dB ∝ sin θ (Zero ahead, max to side)!",
              "Field wire ke chaaron taraf circle karti hai; dB ∝ sin θ (Aage zero, side mein max)!"
            )}
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <g transform="translate(60, 290)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            Magnetic lines never start or end! Isolated magnetic monopoles do not exist in nature!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 7}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Magnetic flux ∮ B · dA = 0 kyunki magnetic lines continuous closed loops hoti hain! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
