    ...
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      <Fade on={beat >= 0} delay={dl(0, 0.4)}>
        <T x={540} y={58} size={24} fill={RED} script>
          {t("Advanced: Magnetic Field at General Angle θ", "Advanced: General Angle θ Par Magnetic Field")}
        </T>
      </Fade>
      <Draw on={beat >= 0} delay={dl(0, 2.5)} d="M 200 70 C 440 66, 640 74, 880 69" stroke={RED} sw={2.4} dur={0.7} />

      {/* BEAT 1 & 3: General Magnitude Formula */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">
          {t("MAGNITUDE AT GENERAL ANGLE θ", "GENERAL ANGLE θ PAR MAGNITUDE")}
        </T>
      </Fade>
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={16} fill={INK} weight={800}>
            B = (μ₀ / 4π) (m / r³) √(1 + 3 cos² θ)
          </T>
          <T x={225} y={52} anchor="middle" size={13} fill={AMBER_DARK} weight={700}>
            {t("Resolves m into parallel (m cos θ) and perpendicular (m sin θ) components!", "m ko (m cos θ) aur (m sin θ) components mein resolve karke milta hai!")}
          </T>
        </g>
      </Fade>

      {/* BEAT 5 & 6: Direction Angle alpha */}
      ...
      <Fade on={beat >= 5} dim={beat >= 7}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={52} anchor="middle" size={14} fill={INK} weight={700}>
            {t("Total angle with dipole axis: φ = θ + α", "Dipole axis se total angle: φ = θ + α")}
          </T>
        </g>
      </Fade>

      {/* BEAT 7: Special Angle Checks */}
      ...
      <Fade on={beat >= 7}>
        <g transform="translate(60, 360)">
          ...
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            θ = 0° ⇒ √(1+3) = 2 (Axial!) | θ = 90° ⇒ √(1+0) = 1 (Equatorial!)
          </T>
        </g>
      </Fade>
