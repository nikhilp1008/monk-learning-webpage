...
export default function P12Ch04Sec13({ currentTime, reveals, language }: SceneProps) {
  ...
  return (
    <svg viewBox="0 0 1080 620" preserveAspectRatio="xMidYMin meet" className="w-full h-full select-none">
      ...
      {/* BEAT 1 & 3: Amperian Circle Line Integral */}
      <Badge n={1} cx={52} cy={140} on={beat >= 1} delay={dl(1, 0.4)} />
      <Fade on={beat >= 1} delay={dl(1, 0.8)}>
        <T x={74} y={145} size={14} fill={RED} weight={700} anchor="start">CIRCULAR AMPERIAN LOOP LINE INTEGRAL</T>
      </Badge>
      <Fade on={beat >= 1} dim={beat >= 5}>
        <g transform="translate(60, 160)">
          <rect x={0} y={5} width={450} height={50} rx={8} fill={CREAM} stroke={AMBER_DARK} strokeWidth={1.8} />
          <T x={225} y={35} anchor="middle" size={16} fill={INK} weight={800}>
            ∮ \vec{B} \cdot d\vec{l} = B (2\pi r)
          </T>
        </g>
      </Fade>

      {/* BEAT 5, 7 & 8: Three Amperian Regions */}
      <Badge n={2} cx={540} cy={140} on={beat >= 5} delay={dl(5, 0.4)} />
      <Fade on={beat >= 5} delay={dl(5, 0.8)}>
        <T x={562} y={145} size={14} fill={RED} weight={700} anchor="start">THREE REGIONS & TOROID FIELD</T>
      </Badge>
      <Fade on={beat >= 5} dim={beat >= 9}>
        <g transform="translate(540, 160)">
          <rect x={0} y={5} width={480} height={60} rx={8} fill={CREAM} stroke={GREEN} strokeWidth={1.8} />
          <T x={240} y={30} anchor="middle" size={14} fill={INK} weight={800}>
            Hollow Center: B = 0   |   Outside: B = 0
          </T>
          <T x={240} y={52} anchor="middle" size={16} fill={GREEN} weight={800}>
            Inside Windings: B = (μ₀ N I) / (2πr)
          </T>
        </g>
      </Fade>

      {/* BEAT 9: Solenoid Equivalence */}
      <Badge n={3} cx={52} cy={270} on={beat >= 9} delay={dl(9, 0.4)} />
      <Fade on={beat >= 9} delay={dl(9, 0.8)}>
        <T x={74} y={275} size={14} fill={RED} weight={700} anchor="start">EQUIVALENCE TO SOLENOID FORMULA</T>
      </Badge>
      <Fade on={beat >= 9}>
        <g transform="translate(60, 290)">
          <rect x={0} y={5} width={960} height={50} rx={8} fill={CREAM} stroke={GREEN} strokeWidth={1.8} />
          <T x={480} y={35} anchor="middle" size={16} fill={GREEN} weight={800}>
            With n = N / (2πr), B_toroid = μ₀ n I! Toroid is a wrapped-around solenoid!
          </T>
        </g>
      </Fade>
      ...
      <Fade on={beat >= 9}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Derived! Toroid B = μ0 N I / (2πr) inside windings, aur B = 0 hollow center & outside mein! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
