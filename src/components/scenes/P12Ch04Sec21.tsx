      ...
      <Fade on={beat >= 1} dim={beat >= 6}>
        <g transform="translate(60, 160)">
          ...
          <T x={225} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            F₁ = F₂ = B I a   (Net Force F_net = 0)
          </T>
          <T x={225} y={52} anchor="middle" size={14} fill={AMBER_DARK} weight={700}>
            (Different lines of action form a couple!)
          </T>
        </g>
      </Fade>

      {/* BEAT 6 & 7: Moment Arm & Torque Derivation */}
      ...
      <Fade on={beat >= 6} dim={beat >= 8}>
        <g transform="translate(540, 160)">
          ...
          <T x={240} y={30} anchor="middle" size={15} fill={INK} weight={800}>
            Arm = b sin θ  ⇒  τ = (BIa)(b sin θ) = B I A sin θ
          </T>
          <T x={240} y={52} anchor="middle" size={18} fill={GREEN} weight={800}>
            ⇒  τ = N I A B sin θ = m B sin θ
          </T>
        </g>
      </Fade>

      {/* BEAT 8: Vector Moment Form */}
      ...
      <Fade on={beat >= 8}>
        <Chip x={100} y={480} w={880} h={44} fill={GREEN} textFill="#ffffff" size={18}>
          {t(
            ...
            "★ Derived! Torque τ = NIAB sin θ = mB sin θ aur vector torque τ = m × B! Essential CBSE proof! ✓"
          )}
        </Chip>
      </Fade>
    </svg>
