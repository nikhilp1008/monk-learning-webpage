...
Sec 7 — Traps, fixes, and the keyword decoder — next. (Finishes the Classification Systems subtopic, secs 1-7 — a good stopping checkpoint after this one if a break is needed.)
